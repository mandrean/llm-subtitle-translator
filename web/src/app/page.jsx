      ...
      <main className='min-h-screen flex flex-col justify-between'>
        ...
        <footer className="flex w-full my-4">
          <div className='mx-auto'>
            <h1 className='text-center'><b className='w-full'>LLM Subtitle Translator Web Interface</b></h1>
            <div className='flex flex-wrap items-center justify-center'>
              ...
              <a href="https://github.com/mandrean/chatgpt-subtitle-translator" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center">
